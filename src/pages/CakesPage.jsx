    ...
    <div className="section">
      <div className="container">
        ...
        <div className='tamanhos'>
          <p className='tamanho1'>tamanho 15cm serve de 12 à 15 fatias</p>
          <p className='tamanho2'>tamanho 20cm serve de 20 à 24 fatias</p>
          <p className='tamanho3'>tamanho 24cm serve de 30 à 34 fatias</p>
        </div>
      </div>
    </div>
  );
